...
for s = 1:nslices
    ...
    statmap = statisticfun(data12slice(1:numobservation1),data12slice(numobservation1+1:end)); %statistic map of original data
    ...
    for i = 2:numpermutation
        ...
        statmapperm = statisticfun( data12slice(permndx(1:numobservation1)) , data12slice(permndx(numobservation1+1:end)) ); %create permutation sample
    end
